 ...
 * <p>For Example:
 * <code>
 *     List&lt;ExplicitlyBiasedSupplier.BiasEntry&lt;Boolean&gt;&gt; biasList = new ArrayList&lt;&gt;();
...
public class ExplicitlyBiasedSupplier<T> implements Supplier<T> {
     ...
     * @param biasList a list of {@link ExplicitlyBiasedSupplier.BiasDetail} that supplies the entries
     *                 and relative proportions of the entries for generation.
     */
    public ExplicitlyBiasedSupplier(List<BiasDetail<T>> biasList) {
    ...
    public boolean equals(Object o) {
        ...
        ExplicitlyBiasedSupplier that = (ExplicitlyBiasedSupplier) o;
    ...
    /**
     * Class used in the construction of the ExplicitlyBiasedSupplier.
